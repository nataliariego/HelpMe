...
//                    Map<String, Object> asignaturaSeleccionada = new HashMap<>();
//                    asignaturaSeleccionada.put("curso");
//
//                    newDuda.setAsignaturaId();

                DudaController.getInstance().saveDuda(newDuda);
                // TODO: crearDuda();
